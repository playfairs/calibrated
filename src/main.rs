use iced::{widget::{button, column, container, row, text, text_input, checkbox}, Application, Command, Element, Length, Renderer, Settings, Theme};
use std::thread;
        ...
        let content = column![
            container(
                row![
                    ...
                    .width(Length::Fill),
                    container(
                        text(status).size(14).style(status_color)
                    )
                    .padding([8, 16])
            ...
            container(
                column![
                    ...
                    row![
                        ...
                        text("h").size(14).style(iced::Color::from_rgb(0.7, 0.7, 0.7)),
                        container(
                        ...
                        .width(Length::Fixed(55.0)),
                        text("m").size(14).style(iced::Color::from_rgb(0.7, 0.7, 0.7)),
                        container(
                        ...
                        .width(Length::Fixed(55.0)),
                        text("s").size(14).style(iced::Color::from_rgb(0.7, 0.7, 0.7)),
                        container(
                        ...
                        text("ms").size(14).style(iced::Color::from_rgb(0.7, 0.7, 0.7))
                    ].spacing(10)
                ].spacing(10)
            )
            .padding(18)
            ...
            container(
                column![
                    ...
                    row![
                        ...
                        .width(Length::Fixed(75.0)),
                        text("−").size(18).style(iced::Color::from_rgb(0.8, 0.8, 0.8)),
                        container(
